...
private:
     ...
     */
    Properties(Data* data, unsigned long* dataIdx);
    Properties(const Properties& copy);

    /**
     * Constructor. Read from the beginning of namespace specified.
     */
    Properties(Data* data, unsigned long* dataIdx, const std::string& name, const char* id, const char* parentID, Properties* parent);
